...
<div class="icon_option"><i class="fa-solid fa-bars fa-xl"></i></div>
    ...
    <div class="incredible_india">
                <h1>Categories</h1>
                <p>
                    In this category page We have tried to add different sides of Indian Heritage and Culture. We have added the following sides in our website.
                    <ul>
                        <li>Ancient civilisations</li>
                        <li>Vedic Period</li>
                        <li>Religious Diversity</li>
                        <li>classical Arts</li>
            ...
            <?php
                        //sql query
                        $sql_result = "SELECT name, img_path, description FROM category";
